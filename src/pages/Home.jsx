...
const Home = () => {
	...
	return (
		...
		// 			<img src="https://i.ibb.co/sJs21k8/IMG-20240301-WA0034.jpg" alt="" className="object-cover w-full h-64 rounded sm:h-96 lg:col-span-7 dark:bg-gray-500" />
		...
		// 				<img role="presentation" className="object-cover w-full rounded h-44 dark:bg-gray-500" src="https://i.ibb.co/w44fDyp/IMG-20240301-113607.jpg" />
